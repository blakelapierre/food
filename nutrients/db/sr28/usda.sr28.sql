...
CREATE TABLE "sr28"."DATSRCLN" ("NDB_No" text, "Nutr_No" text, "DataSrc_ID" text NOT NULL REFERENCES "sr28"."DATA_SRC", PRIMARY KEY ("NDB_No", "Nutr_No", "DataSrc_ID"));
...
CREATE TABLE "sr28"."NUT_DATA" ("NDB_No" text, "Nutr_No" text, "Nutr_Val" NUMERIC(10,3) NOT NULL, "Num_Data_Pts" NUMERIC(5), "Std_Error" NUMERIC(8,3), "Src_Cd" text NOT NULL REFERENCES "sr28"."SRC_CD", "Deriv_Cd" text REFERENCES "sr28"."DERIV_CD", "Ref_NDB_No" text, "Add_Nutr_Mark" text, "Num_Studies" NUMERIC, "Min" NUMERIC(10,3), "Max" NUMERIC(10,3), "DF" NUMERIC(4), "Low_EB" NUMERIC(10,3), "Up_EB" NUMERIC(10,3), "Stat_cmt" text, "AddMod_Date" text, "CC" text, PRIMARY KEY ("NDB_No", "Nutr_No"));
...
CREATE TABLE "sr28"."FOOD_DES" ("NDB_No" text, "FdGrp_Cd" text NOT NULL REFERENCES "sr28"."FD_GROUP", "Long_Desc" text NOT NULL, "Short_Desc" text NOT NULL, "ComName" text, "ManufacName" text, "Survey" text, "Ref_desc" text, "Refuse" text, "SciName" text, "N_Factor" text, "Pro_Factor" text, "Fat_Factor" text, "CHO_Factor" text, PRIMARY KEY ("NDB_No"));
